quick_draw_data_set = ["aircraft carrier", "airplane", "alarm clock", "ambulance", "angel",
    ...
    "dolphin", "donut", "door", "dragon", "dresser", "drill", "drums", "duck", "dumbbell", "ear",
    "elbow", "elephant", "envelope", "eraser", "eye", "eyeglasses", "face", "fan", "feather",
    ...
    "garden", "garden hose", "giraffe", "goatee", "golf club", "grapes", "grass", "guitar", "hamburger",
    ...
    "snail", "snake", "snorkel", "snowflake", "snowman", "soccer ball", "sock", "speedboat", "spider",
    ...
    "submarine", "suitcase", "sun", "swan", "sweater", "swingset", "sword", "syringe", "table",
    "teapot", "teddy-bear", "telephone", "television", "tennis racquet", "tent",
    "The Eiffel Tower", "The Great Wall of China", "The Mona Lisa", "tiger", "toaster", "toe",
    "toilet", "tooth", "toothbrush", "toothpaste", "tornado", "tractor", "traffic light",
    "train", "tree", "triangle", "trombone", "truck", "trumpet", "tshirt", "umbrella",
    "underwear", "van", "vase", "violin", "washing machine", "watermelon", "waterslide",
...
Random=Math.floor(Math.random()*quick_draw_data_set.length);
console.log(Random);
...
function check_sketch(){
 ...
 setInterval(myGreeting,1000)
    function myGreeting() {
        total_seconds++;
        document.getElementById("timer").innerHTML="Timer: "+ total_seconds;
        if(total_seconds>20){
            total_seconds=0;
